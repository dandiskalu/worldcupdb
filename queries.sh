...
echo -e "$($PSQL "SELECT DISTINCT(name) FROM teams AS t11 FULL JOIN games AS g22 ON t11.team_id = g22.winner_id FULL JOIN games AS g11 ON t11.team_id = g11.opponent_id WHERE (g11.year='2014' OR g22.year='2014') AND (g11.round='Eighth-Final' OR g22.round='Eighth-Final') ORDER BY name")"
